    ...
    <div class="contenido">
        <header>
            ...
            <nav class="content-navBar">
                <ul>
                    <li><a href="home.php" style="text-decoration:none" class="content-navBar--active">Inicio</a></li>
                    <li><a href="contacto_paciente.php" style="text-decoration:none" class="content-navBar--noactive">Contacto</a></li>
                </ul>
            </nav>
